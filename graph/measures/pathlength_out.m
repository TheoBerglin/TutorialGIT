...
%
% PLOUT = PATHLENGTH_OUT(A,type) calculates the out-pathlength PLOUT of
...
%
% The out-pathlength is the average shortest path length from a
%   particular node to all other nodes. The out-pathlength of
