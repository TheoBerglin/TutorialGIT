function res = strength_average( A, type)
% STRENGTH_AVERAGE average of the strength of a node
%
% RES = STRENGTH_AVERAGE(A, TYPE) calculates the average of the strength
