function [test_struct, test_func] = test_global_efficiency_out_average(  )
%TEST_GLOBAL_EFFICIENCY_OUT_AVERAGE Test suite for the average of the out-global efficiency measure
%
...
%% Initializations
test_func = 'global_efficiency_out_average';
N = 5; % number of nodes
...
A3 = [1 1 0 0 0;
    ...
    0 0 0 1 1];
type3 = Graph.BD;
exp_res3 = mean([7/12 7/8 17/24 3/4 7/12]);
...
A4 = [0 0 0 1 0;
    ...
    0 1 0 1 0];
type4 = Graph.BU;
exp_res4 = mean([7/12 17/24 3/4 7/8 3/4]);
...
A5 = [0 1/2 0 0 0;
    ...
    0 0 0 1/5 0];
type5 = Graph.WD;
exp_res5 = mean([63/200 575/816 866/2505 127/210 391/2400]);
...
A6 = [0 1/2 0 2 0;
    ...
    0 2 0 3 0];
type6 = Graph.WU;
exp_res6 = mean([751/720 2411/2320 467/2053 129/80 209/130]);
