function [test_struct, test_func] = test_global_efficiency_in_average(  )
%TEST_GLOBAL_EFFICIENCY_IN_AVERAGE Test suite for the average of the in-global efficiency measures
%
...
%% Initializations
test_func = 'global_efficiency_in_average';
N = 5; % number of nodes
...
A3 = [1 1 0 0 0;
    ...
    0 0 0 1 1];
type3 = Graph.BD;
exp_res3 = mean([3/4 13/24 7/12 7/8 3/4]);
...
A5 = [0 1/2 0 0 0;
    ...
    0 0 0 1/5 0];
type5 = Graph.WD;
exp_res5 = mean([43/96 197/672 144/425 1/3 781/1085]);
