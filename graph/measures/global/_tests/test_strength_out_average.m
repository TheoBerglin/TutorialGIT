function [test_struct, test_func] = test_strength_out_average(  )
%TEST_STRENGTH_OUT_AVERAGE Test suite for the average of the out strength measure
%
...
%% Initializations
test_func = 'strength_out_average';
N = 5; % number of nodes
