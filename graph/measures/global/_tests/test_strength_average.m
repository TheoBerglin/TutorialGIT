function [test_struct, test_func] = test_strength_average(  )
%TEST_STRENGTH_AVERAGE Test suite for the average of the strength measure
%
...
A6 = [1 6 0 0 7;
    ...
    7 0 0 6 1];
type6 = Graph.WU;
exp_res6 = mean([26 22 18 20 26]/2);
