function [test_struct, test_func] = test_global_efficiency_average(  )
%TEST_GLOBAL_EFFICIENCY_AVERAGE Test suite for the average of the global efficiency measures
%
...
%% Initializations
test_func = 'global_efficiency_average';
N = 5; % number of nodes
...
A3 = [1 1 0 0 0;
    ...
    0 0 0 1 1];
type3 = Graph.BD;
exp_res3 = mean([2/3 17/24 31/48 13/16 2/3]);
...
A5 = [0 1/2 0 0 0;
    ...
    0 0 0 1/5 0];
type5 = Graph.WD;
exp_res5 = mean([1041/2729 228/457 728/2127 197/420 685/1552]);
