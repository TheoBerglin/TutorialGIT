% File to test the use of path length-out measure.
%
...
%% Perform tests
disp('Running tests for path length-out calculations')
tol = 1e-6;
for i=1:length(test_struct)
    ...
    try
        pl = pathlength_out(connectivity_matrix, type);
    catch MException
