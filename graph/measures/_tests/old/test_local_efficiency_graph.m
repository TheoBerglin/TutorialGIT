% File to test the use of the local efficiency graph measure.
%
...
%% Perform tests
disp('Running tests for local efficiency graph calculations')
tol = 1e-6;
for i=1:length(test_struct)
    ...
    try
        le = local_efficiency_graph(connectivity_matrix, type);
    catch MException
