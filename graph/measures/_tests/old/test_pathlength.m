% File to test the use of path length measure.
%
...
A4 = [1 1 0 0 0;
    ...
    0 0 0 1 1];
type4 = Graph.BD;
exp_res4 = [7/4 7/4 15/8 11/8 7/4];
...
%% Perform tests
disp('Running tests for path length calculations')
tol = 1e-6;
for i=1:length(test_struct)
    ...
    try
        pl = pathlength(connectivity_matrix, type);
    catch MException
