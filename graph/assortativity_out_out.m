function r = assortativity_out_out( A, type )
% ASSORTATIVITY_OUT_OUT out-out-assortativity of a graph
%
% R = ASSORTATIVITY_OUT_OUT(A, TYPE) calculates the out-out-assortativity of
