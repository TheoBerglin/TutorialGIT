function [W0, R] = randomize_gio_bct_D(W,wei_freq)
...
%   distributions. This function calls randm_giovanni_bd.m
%
...
%
%   tic; [W0_slow R_slow]=null_model_dir_sign(W,1); R_slow, toc
%
%   R_slow =
...
%
%   tic; [W0_fast R_fast]=null_model_dir_sign(W,0.1); R_fast, toc
%
%   R_fast =
