function [rW,R] = randomize_braph_WU(W,bin_swaps,wei_freq)
% RANDOMIZE_BRAPH_WU randomizes the graph using the BRAPH algorithm
%
% [rW,R] = RANDOMIZE_BRAPH_WU(W,bin_swaps,wei_freq) randomizes the graph 
%   represented by the adjacency matrix W and returns the new weighted undirected
