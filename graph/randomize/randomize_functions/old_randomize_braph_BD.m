function [rW,R] = randomize_braph_BD(W,bin_swaps,wei_freq)
% RANDOMIZE_BRAPH_BD randomizes the graph using the BRAPH algorithm
%
% [rW,R] = RANDOMIZE_BRAPH_BD(W, bin_swaps, wei_freq) randomizes the graph 
%   represented by the adjacency matrix W and returns the new binary directed
