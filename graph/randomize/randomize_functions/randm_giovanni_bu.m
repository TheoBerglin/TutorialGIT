...
%   preserving the egree of each node.
%   Therefore, also the degree distribution is preserved.
%   
% [B,MW] = RANDM_BU(A,I,ERROR) permits one to set
...
%   The connected nodes of B can be connected by two edges (bi-directional)
