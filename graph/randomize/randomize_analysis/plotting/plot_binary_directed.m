function plot_binary_directed(  )
%PLOT_CPL Summary of this function goes here
%   Detailed explanation goes here

bin = 'binary';
dir_type = 'directed';
dir_type_opposite = 'undirected';
...
data_name = 'binary_directed_plot_data';
...
x_marker = 10.1;
x_text = 10.6;
plot(x_marker, y_legend, '^', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', colors{2}, 'MarkerSize', 10)
plot(x_marker, y_legend+d_legend, 'd', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'y', 'MarkerSize', 10)
plot(x_marker,  y_legend+2*d_legend, 'o', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', colors{1}, 'MarkerSize', 10)
plot(x_marker,  y_legend+3*d_legend, 's', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', colors{3}, 'MarkerSize', 10)
annotation('rectangle',...
    [0.31 0.642 0.208 0.11], 'LineWidth', 1.5);



text(x_text, y_legend, ...
    '$\mathrm{BCT}$','Interpreter','latex',...
    'HorizontalAlignment','left','VerticalAlignment','middle','FontSize',16)
text(x_text, y_legend+d_legend, ...
    '$\mathrm{BCT}~\mathrm{special}$','Interpreter','latex',...
    'HorizontalAlignment','left','VerticalAlignment','middle','FontSize',16)
text(x_text, y_legend+2*d_legend, ...
    '$\mathrm{BCT}~\mathrm{edit}$','Interpreter','latex',...
    'HorizontalAlignment','left','VerticalAlignment','middle','FontSize',16)
text(x_text, y_legend+3*d_legend, ...
    '$\mathrm{BRAPH}$','Interpreter','latex',...
    'HorizontalAlignment','left','VerticalAlignment','middle','FontSize',16)
h_max = maxis2d([log(x_start_value*0.7) log(2.5e5)], [log(y_min_value*0.1) log(25e3)],...
    'X0', 5.1,...
    'Y0', -11,...
    'XTicks',x_values,...
