function plot_weighted_directed(  )
...
%% Plot figure
%% Plot figure
data_name = 'weighted_directed_plot_data';
...
xlab = 'Nodes';
ylab = 'Time [s]';
h_max = maxis2d([log(x_start_value*0.65) log(1.5*x_end_value)], [log(y_min_value*0.1) log(25e3)],...
    'X0', 5,...
    'Y0', -9.7,...
    'XTicks',x_values,...
    'XTickLabels',{'200', '$10^3$', '$10^4$'},...
