...
% Version: 1.0.0, 01/07/13
% Contact: Dr. Giovanni Volpe <giovanni.volpe@opfocus.org>

% Permission is granted to distribute ARROW2D with the toolboxes for the book
...
for i = 1:1:length(xticklabels)
    ...
    set(h.xticklabels(i),'Position',[xticks(i)-0.5*ex(3), y0-0.6*ex(4)])
end
