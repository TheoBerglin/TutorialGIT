...
xlab_pos = [6.5 -0.02 6.5 -0.02 6.5 -0.02 6.5 -0.02];
...
%     bar([gt_values; gt_edit_values; braph_values])
    ...
    maxis2d([start_value*0.9 end_value*1.1], [-0.01 max_value*1.1],...
        'X0', start_value,...
        'XTicks',xticks,...
...
pos1_x = xpos_col1 + size_x_axes/2;
pos1_y = ypos_row2 + size_y_axes - 30;
text(pos1_x+60, pos1_y-10, ...
    '$\mathrm{BCT}$','Interpreter','latex',...
    'HorizontalAlignment','left','VerticalAlignment','middle','FontSize',15,...
    'Color',colors{1})
text(pos1_x+60, pos1_y-30, ...
    '$\mathrm{BCT}~\mathrm{edit}$','Interpreter','latex',...
    'HorizontalAlignment','left','VerticalAlignment','middle','FontSize',15,...
    'Color',colors{2})
text(pos1_x+60, pos1_y-50, ...
