function [test_struct, test_func] = test_global_efficiency_in(  )
%TEST_GLOBAL_EFFICIENCY_IN Test suite for the in-global efficiency measures
%
...
%% Initializations
test_func = 'global_efficiency_in';
N = 5; % number of nodes
...
A3 = [1 1 0 0 0;
    ...
    0 0 0 1 1];
type3 = Graph.BD;
exp_res3 = [3/4 13/24 7/12 7/8 3/4];
