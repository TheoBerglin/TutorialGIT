function [ passed, details ] = test_distance(  )
%TEST_DISTANCE Test function for the distance measures
%
...
A7 = [-1 4 0 0 0;
    ...
    0 0 0 3.1 -0.4];
type7 = Graph.WDN;
exp_res7 = [0 1/4 51/62 10/31 0;
    -431/2604 0 71/124 9/124 -1/4;
    -41/84 -5/21 0 -1/4 -41/84;
    -5/21 1/84 1/2 0 -5/21;
    55/651 484/1447 51/62 10/31 0];
