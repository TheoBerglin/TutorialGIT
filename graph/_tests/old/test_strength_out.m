% File to test the use of out strength measure.
%
...
known_2 = [1 -6 0 0 7;
    ...
    0 0 5 1 -3;
    -7 0 0 6 1];
strength_out_2 = [1 -2 0 2 -1];

%% Test (positive) weighted matrix no decimal

A3 = known_1;
exp_res3 = strength_out_1;
type3 = Graph.WD;
...
A6 = known_2/10;
exp_res6 = strength_out_2/10;
type6 = Graph.WD;
test_struct(6) = get_test_struct(A6, type6, exp_res6, 'Weighted negative matrix decimal');

%% Perform test

disp('Running tests for out strength calculations')
threshold = 1e-6;
for i=1:length(test_struct)
    res = strength_out(test_struct(i).connectivity);
