function [test_struct, test_func] = test_global_efficiency_out(  )
%TEST_GLOBAL_EFFICIENCY_OUT Test suite for the out-global efficiency measure
%
...
%% Initializations
test_func = 'global_efficiency_out';
N = 5; % number of nodes
...
A3 = [1 1 0 0 0;
    ...
    0 0 0 1 1];
type3 = Graph.BD;
exp_res3 = [7/12 7/8 17/24 3/4 7/12];
